...
def evaluate_board(board, player, selectedStone = None, destination = None):
    ...
    if level == 0:
       # Broj dostupnih poteza
        ...
        # Evaluate the board based on the above factors
        score = (5 * player_moves + 2.5 * player_mills + 4 * player_potential_mills + player_pieces_in_mills - 2 * player_stones_in_mills) - (3 * opponent_moves + 2 * opponent_mills + opponent_potential_mills + opponent_pieces_in_mills - 2 * opponent_stones_in_mills)
    return score